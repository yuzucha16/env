...
set "FILES[6]=wt-left.ahk|%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\wt-left.ahk"
set "FILES[7]=config\git\config|%USERPROFILE%\.config\git\config"
set "FILES[8]=home\.gitconfig|%USERPROFILE%\.gitconfig"
set "FILES[9]=home\.gitignore_global|%USERPROFILE%\.gitignore_global"
...
set "FILES[13]=config\goneovim\settings.toml|%USERPROFILE%\.config\goneovim\settings.toml"
set "FILES[14]=config\starship\starship.toml|%USERPROFILE%\.config\starship.toml"
set "FILES[15]=vscode|%APPDATA%\Code\User"
...
set "FILES[20]=config\nushell\config.nu|%USERPROFILE%\.config\nushell\env.nu"
set "FILES[21]=xyplorer|%VAULT_HOME%\tool\xyplorer_full_noinstall\Data"
set "FILES[22]=typora\conf.user.json|%APPDATA%\Typora\conf\conf.user.json"
set "FILES[23]=typora\themes|%APPDATA%\Typora\themes"
set "MAX_IDX=23
