...
set "FILES[10]=vscode\extensions.json|%USERPROFILE%\scoop\persist\vscode\data\extensions\extensions.json"
...
set "FILES[14]=xyplorer|%XDG_BIN_HOME%\xyplorer_full_noinstall\Data"
set "FILES[15]=typora\conf.user.json|%APPDATA%\Typora\conf\conf.user.json"
set "FILES[16]=typora\themes|%APPDATA%\Typora\themes"
set "MAX_IDX=16
