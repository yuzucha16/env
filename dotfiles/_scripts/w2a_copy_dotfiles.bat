...
set "FILES[12]=vscode\extensions_vscode.json|%USERPROFILE%\scoop\persist\vscode\data\extensions\extensions.json"
set "FILES[13]=vscode\extensions_vscode.txt|%USERPROFILE%\scoop\persist\vscode\data\extensions\extensions.txt"
...
set "FILES[17]=xyplorer|%XDG_BIN_HOME%\xyplorer_full_noinstall\Data"
set "FILES[18]=typora\conf.user.json|%APPDATA%\Typora\conf\conf.user.json"
set "FILES[19]=typora\themes|%APPDATA%\Typora\themes"
set "MAX_IDX=19
