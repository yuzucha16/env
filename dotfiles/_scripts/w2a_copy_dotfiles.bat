...
set "FILES[10]=vscode\keybindings.json|%USERPROFILE%\scoop\persist\vscode\data\user-data\User\keybindings.json"
set "FILES[11]=vscode\extensions_vscode.json|%USERPROFILE%\scoop\persist\vscode\data\extensions\extensions.json"
set "FILES[12]=autohotkey\Autohotkey64.ahk|%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\Autohotkey64.ahk"
set "FILES[13]=Microsoft.PowerShell_profile.ps1|%USERPROFILE%\Documents\PowerShell\Microsoft\PowerShell_profile.ps1"
set "FILES[14]=profile.ps1|%USERPROFILE%\Documents\PowerShell\profile.ps1"
set "FILES[15]=xyplorer|%XDG_BIN_HOME%\xyplorer_full_noinstall\Data"
set "FILES[16]=typora\conf.user.json|%APPDATA%\Typora\conf\conf.user.json"
set "FILES[17]=typora\themes|%APPDATA%\Typora\themes"
set "MAX_IDX=17
