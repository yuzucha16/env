...
set "FILES[12]=vscode\extensions_wsl.json|%WSL_HOME%\.vscode-server\extensions\extensions.json"
...
set "FILES[16]=xyplorer|%XDG_BIN_HOME%\xyplorer_full_noinstall\Data"
